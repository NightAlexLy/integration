 ...
 *
 */
public class LBSubscriber
{
    private final String connectionUri = "failover:(tcp://localhost:51616,tcp://localhost:51617)";
    ...
    public void run() throws Exception {
        ...
        consumer.setMessageListener(new LBEventListener());
    ...
    public static void main(String[] args) {
        LBSubscriber producer = new LBSubscriber();
        System.out.print("\n\n\n");
